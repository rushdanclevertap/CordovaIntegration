...
document.getElementById("inapp").addEventListener("click",onInappCordova);
...
//            'Identity': '9766609',
            ...
            'Email': 'rushdancordova@clevertap.com'

        });

         CleverTap.createNotificationChannel("1999", "Channel1999", "ChannelDescription", 5, true);
...
{
//alert("Hi");
CleverTap.recordEventWithName("rushcordova");
}

function onInboxCordova()
{
CleverTap.recordEventWithName("Inboxxxx");
...
{
 CleverTap.recordEventWithName("NativeDsiplayRushdan");
...
function onInappCordova()
{
CleverTap.recordEventWithName("Rushdanflutterinapp");//Rushdanflutterinapp same as Inboxxxxjust the event name dw
...
//    initialize: function() {
//        document.addEventListener('deviceready', onDeviceReady, false);
//         document.getElementById('bt1').addEventListener("click", this.pushEvent);
//    },
